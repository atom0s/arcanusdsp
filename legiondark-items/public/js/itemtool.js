...
// Obtain the LegionDark angular module..
 ...
 * are added to the LegionDark website via the legiondark-items plugin.
 *
 * @author atom0s <atom0s@live.com>
 * @copyright Copyright (C) 2015-2016 atom0s [atom0s@live.com]
 */
legion.controller('itemToolController', ['$filter', '$http', '$sce', '$scope', '$window', function ($filter, $http, $sce, $scope, $window) {
 ...
 */
legion.filter('pageCount', function () {
 ...
 */
legion.filter('itemDamageType', function () {
    return function (val) {
 ...
 * @returns {string}                The converted value.
 */
legion.filter('itemFlags', function () {
    return function (val) {
        var flags = [];
 ...
 * @returns {string}                The converted value.
 */
legion.filter('itemSkillType', function () {
    return function (val) {
 ...
 * @returns {string}                The converted value.
 */
legion.filter('itemSkillSubType', function () {
    return function (val) {
 ...
 * @returns {string}                The converted value.
 */
legion.filter('itemSlots', function () {
    return function (val) {
        if (val === 0)
            return 'None';
 ...
 * @returns {string}                The converted value.
 */
legion.filter('itemUsableJobs', function () {
    return function (val) {
 ...
 * @returns {string}                The converted value.
 */
legion.filter('itemValidTargets', function () {
    return function (val) {
        var targets = [];
 ...
 * @returns {string}                The converted value.
 */
legion.filter('itemMod', function () {
    return function (val) {
        const mods = {
 ...
 * @returns {string}                The converted value.
 */
legion.filter('craftRequirements', function () {
    return function (val) {
        var ret = '';
