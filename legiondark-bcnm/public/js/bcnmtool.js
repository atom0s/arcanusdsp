 ...
 * are added to the LegionDark website via the legiondark-bcnm plugin.
 *
 * @author atom0s <atom0s@live.com>
 * @copyright Copyright (C) 2015-2016 atom0s [atom0s@live.com]
 */
legion.controller('bcnmToolController', ['$filter', '$http', '$sce', '$scope', '$window', function ($filter, $http, $sce, $scope, $window) {
    $scope.bcnm = null;
 ...
 * @returns {string}                The converted value.
 */
legion.filter('bcnmRules', function () {
    return function (val) {
        if (val == null || val === 0)
